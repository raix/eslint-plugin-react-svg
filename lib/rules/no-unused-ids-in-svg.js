...
const validAttibutes = [...tagList.referenceAttributeId, ...tagList.referenceAttributeUrl];
    ...
    create: function(context) {
        ...
        return {
            ...
            JSXAttribute(node) {
                ...
                if (name !== "id" && validAttibutes.includes(name) === false) {
                    return;
                }
                if (name === "id") {
                    idMap.set(id, node);
                ...
                if (tagList.referenceByHref.includes(parentName) && tagList.referenceAttributeId.includes(name)) {
